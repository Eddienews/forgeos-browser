...
const api = {
  ...
  newTab: (url, containerId) => ipcRenderer.invoke('forge:new-tab', url, containerId),
  closeTab: (id) => ipcRenderer.invoke('forge:close-tab', id),
  switchTab: (id) => ipcRenderer.invoke('forge:switch-tab', id),
  findOpen: () => ipcRenderer.invoke('forge:find-open'),
  findSearch: (query, direction) => ipcRenderer.invoke('forge:find-search', query, direction),
  findClose: () => ipcRenderer.invoke('forge:find-close'),
  onFindResult: (cb) => ipcRenderer.on('forge:find-result', (_e, status) => cb(status)),
  onFindShortcut: (cb) => ipcRenderer.on('forge:find-shortcut', (_e, shortcut) => cb(shortcut)),
  ...
  sitePrivacy: () => ipcRenderer.invoke('forge:site-privacy'),
  siteException: (kind, enabled) => ipcRenderer.invoke('forge:site-exception', kind, enabled),
  siteClear: () => ipcRenderer.invoke('forge:site-clear'),
  presetsList: () => ipcRenderer.invoke('forge:presets-list'),
  presetApply: (name) => ipcRenderer.invoke('forge:preset-apply', name),
  presetRevoke: (name) => ipcRenderer.invoke('forge:preset-revoke', name),
  ...
  notebook: Object.freeze({
    list: () => ipcRenderer.invoke('forge:notebook-list'),
    capture: () => ipcRenderer.invoke('forge:notebook-capture'),
    notes: (value) => ipcRenderer.invoke('forge:notebook-notes', value),
    compare: (ids) => ipcRenderer.invoke('forge:notebook-compare', ids),
    remove: (id) => ipcRenderer.invoke('forge:notebook-remove', id),
    export: () => ipcRenderer.invoke('forge:notebook-export'),
  }),
